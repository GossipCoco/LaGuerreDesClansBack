...
const TypeRelation = connection.define('TypeRelation',{
    Id: {
        type: DataTypes.STRING,
        primaryKey: true,
    },
...
const OtherAnimal = connection.define('OtherAnimal',{
    Id: {
        type: DataTypes.STRING,
        primaryKey: true,
    },
...
const Prey = connection.define('Prey',{
    Id: {
        type: DataTypes.STRING,
        primaryKey: true,
    },
...
const Ennemy = connection.define('Ennemy',{
    Id: {
        type: DataTypes.STRING,
        primaryKey: true,
    },
...
Character.belongsTo(Grade, {foreignKey: 'Id' })
